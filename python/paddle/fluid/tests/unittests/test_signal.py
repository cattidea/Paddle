...
@parameterize(
    ...
    [
        ...
        (
            'test_3d_input2',
            rand_x(3, np.float64, shape=[4, 2, 150]),
            50,
            15,
            -1,
        ),
...
@parameterize(
    ...
    [
        ...
        (
            'test_frame_length1',
            rand_x(2, np.float64, shape=[150, 8]),
            0,
            15,
            0,
            ValueError,
...
@parameterize(
    ...
    [
        ...
        (
            'test_hop_length',
            rand_x(2, np.float64, shape=[50, 3]),
            -1,
            -1,
            ValueError,
        ),
...
@parameterize(
    ...
    [
        (
            'test_1d_input',
            rand_x(1, np.float64, shape=[160000]),
            512,
            None,
            None,
            get_window('hann', 512),
        ...
        (
            'test_2d_input',
            rand_x(2, np.float64, shape=[1, 160000]),
            512,
            None,
            None,
            get_window('hann', 512),
...
@parameterize(
    ...
    [
        (
            'test_dims',
            rand_x(1, np.float64, shape=[1, 2, 3]),
            512,
            None,
            None,
            None,
        ...
        (
            'test_hop_length',
            rand_x(1, np.float64, shape=[16000]),
            512,
            0,
            None,
            None,
        ...
        (
            'test_complex_onesided',
            rand_x(1, np.float64, shape=[16000], complex=True),
            512,
            None,
            None,
            None,
...
@parameterize(
    ...
    [
        (
            'test_2d_input',
            rand_x(2, np.float64, shape=[257, 471], complex=True),
            512,
            None,
            None,
            get_window('hann', 512),
        ...
        (
            'test_3d_input',
            rand_x(3, np.float64, shape=[1, 257, 471], complex=True),
            512,
            None,
            None,
            get_window('hann', 512),
...
@parameterize(
    ...
    [
        (
            'test_dims',
            rand_x(4, np.float64, shape=[1, 2, 3, 4], complex=True),
            512,
            None,
            None,
            get_window('hann', 512),
        ...
        (
            'test_window',
            rand_x(3, np.float64, shape=[1, 512, 471], complex=True),
            512,
            None,
            511,
            get_window('hann', 512),
        ...
        (
            'test_return_complex2',
            rand_x(3, np.float64, shape=[1, 257, 471], complex=True),
            512,
            None,
            None,
            rand_x(1, np.float64, shape=[512], complex=True),
            True,
            False,
            True,
            None,
